...
public class BasicBankJointNum {
    /**  */
    private Long id;
    ...
    public String getBankJointNum() {
        return bankJointNum;
    }

    public void setBankJointNum(String bankJointNum) {
        this.bankJointNum = bankJointNum == null ? null : bankJointNum.trim();
    }
