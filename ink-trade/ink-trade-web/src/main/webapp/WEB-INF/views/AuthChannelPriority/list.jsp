...
<form id="queryForm" name="queryForm" action="<c:url value="/AuthChannelPriority/list.do"/>" method="post" style="display: inline;">
	...
	<h2> 列表</h2>
		...
		<div>
     	 ...
     	 <yk:page url="${yk}/AuthChannelPriority/list.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>

<script type="text/javascript">
function show(id){
	window.open('${yk}/AuthChannelPriority/show.do?'+$('#pkName').val()+'='+id,'','height=600,width=600,resizable=yes,location=no,scrollbars');
}
function edit(id){
	window.open('${yk}/AuthChannelPriority/edit.do?'+$('#pkName').val()+'='+id,'','height=600,width=600,resizable=yes,location=no,scrollbars');
}
