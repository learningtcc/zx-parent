...
public class MchAuthController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/MchAuth/list";
	protected static final String CREATE_JSP = "/MchAuth/create";
	protected static final String EDIT_JSP = "/MchAuth/edit";
	protected static final String SHOW_JSP = "/MchAuth/show";
