...
public class MchBankController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/MchBank/list";
	protected static final String CREATE_JSP = "/MchBank/create";
	protected static final String EDIT_JSP = "/MchBank/edit";
	protected static final String SHOW_JSP = "/MchBank/show";
