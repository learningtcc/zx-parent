...
public class AuthController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/Auth/list";
	protected static final String CREATE_JSP = "/Auth/create";
	protected static final String EDIT_JSP = "/Auth/edit";
	protected static final String SHOW_JSP = "/Auth/show";
