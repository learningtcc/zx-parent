...
public class AuthOrderController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/AuthOrder/list";
	protected static final String CREATE_JSP = "/AuthOrder/create";
	protected static final String EDIT_JSP = "/AuthOrder/edit";
	protected static final String SHOW_JSP = "/AuthOrder/show";
