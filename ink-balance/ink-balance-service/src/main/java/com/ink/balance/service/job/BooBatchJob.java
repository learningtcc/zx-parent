 ...
 * @date 2016-06-16
 */
@Component("booBatchJob")
public class BooBatchJob extends AbstractBaseJob {
    ...
    public void execute(){
    	 try {
             ...
             checkChannel.setChannelNo(SysParamConst.BOOFOO_CHANNEL_NO);
             checkChannel.setChannelMerchantNo(SysParamConst.BOOFOO_MERCHANT_NO);
             ...
             logger.error(LoggerCnst.BALANCE_MOUDLE, LoggerCnst.SPRING_BATCH_BUS,
                     "HTTP定时请求，开始解析宝付渠道数据并入库异常", e, null);
         }
    }
