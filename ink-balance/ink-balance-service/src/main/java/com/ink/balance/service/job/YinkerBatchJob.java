...
/**
 * 
* <p>Title:YinkerBatchJob </p>
* <p>Description: </p>
* <p>Company: </p> 
* @author zhaojie
* @date 2016年7月13日 上午11:11:30
 */
@Component("yinkerBatchJob")
public class YinkerBatchJob extends AbstractBaseJob {
    ...
    public void execute(){
    	 try {
             ...
             checkChannel.setChannelNo(SysParamConst.YKLM_CHANNEL_NO);
             checkChannel.setChannelMerchantNo(SysParamConst.YK_LM_MERCHANT_NO);
             channelDataManager.readBatchYinkerData(checkChannel);
         } catch (Exception e) {
             logger.error(LoggerCnst.BALANCE_MOUDLE, LoggerCnst.SPRING_BATCH_BUS,
                     "HTTP定时请求，开始解析银客懒猫数据并入库异常", e, null);
         }
    }
