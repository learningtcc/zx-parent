 ...
 * @Description TODO
 * @author xuguoqi
 * @date 2016年5月13日 上午11:43:54
 */
package com.ink.balance.channelDate;
...
public class MyFTP {
	...
	public static void main(String[] args) {
		File imagefile = new File("E:/test1.xlsx");
	    String imagefileFileName = "20160505165533.xlsx";
	    //创建ftp客户端
	    FTPClient ftpClient = new FTPClient();
	    ftpClient.setControlEncoding("utf-8");
	    String hostname = "10.1.5.230";
	    int port = 21;
	    String username = "ftpde";
