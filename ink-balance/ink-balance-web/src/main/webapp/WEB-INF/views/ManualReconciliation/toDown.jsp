		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td><select name="channelMerchantNo" id="channelMerchantNo">
						...
						<option value="YKLM10086"
							<c:if test="${'YKLM10086' eq channelMerchantNo}">selected</c:if>>银客-懒猫</option>
				</select></td>
				<td>
					<div align="center">
						<input type="button" class="btn01" value="入库"
			...
			<tr>
				...
				<td><input onClick="WdatePicker()"
					value="<c:out value="${createBeginDate}"/>" id="checkDate"
					name="checkDate" size="10" readonly="readonly" /></td>
			</tr>
	    	...
	    	if(confirm("确定要对账入库吗？"))
	    	 {
			        ...
			        $.ajax({
			            url: '${yk}/ManualReconciliation/readData.do',    //请求的url地址
			            data: params,
