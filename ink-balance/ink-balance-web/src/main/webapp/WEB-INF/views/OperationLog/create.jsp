...
<body>
	...
	<form id="form1" action="${yk}/OperationLog/save.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00"
			...
			<tr>
				...
				<td><input id="tableName" name="tableName" type="text"
					class="input04" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">操作表主键：</td>
				<td><input id="tableId" name="tableId" type="text"
					class="input04" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">操作表字段：</td>
				<td><input id="tableColumn" name="tableColumn" type="text"
					class="input04" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">原始内容：</td>
				<td><input id="oldContent" name="oldContent" type="text"
					class="input04" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">更新内容：</td>
				<td><input id="newContent" name="newContent" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input id="operator" name="operator" type="text"
					class="input04" /></td>
			</tr>
