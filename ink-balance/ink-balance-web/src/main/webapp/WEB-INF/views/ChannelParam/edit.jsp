...
<body>
	...
	<form id="form1" action="${yk}/ChannelParam/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00"
			...
			<tr>
				...
				<td><input id="name" name="name"
					value="<c:out value="${model.name}"/>" type="text" class="input04" />
			...
			<tr>
				...
				<td><input id="no" name="no"
					value="<c:out value="${model.no}"/>" type="text" class="input04" />
			...
			<tr>
				...
				<td><input
					...
					id="cutDayStartString"
					value="<fmt:formatDate value="${model.cutDayStart}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					name="cutDayStartString" size="20" readonly="readonly" /></td>
			</tr>
			...
			<tr>
				...
				<td><input
					onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
					id="cutDayEndString"
					value="<fmt:formatDate value="${model.cutDayEnd}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					name="cutDayEndString" size="20" readonly="readonly" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">文件定位:</td>
				<td><input id="fileAddress" name="fileAddress"
					value="<c:out value="${model.fileAddress}"/>" type="text"
					class="input04" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">文件获取方式:</td>
				<td><input id="fileGetModel" name="fileGetModel"
					value="<c:out value="${model.fileGetModel}"/>" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input id="resideDays" name="resideDays"
					value="<c:out value="${model.resideDays}"/>" type="text"
					class="input04" /></td>
			</tr>
