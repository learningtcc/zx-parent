...
<body style="background-color: #2281B3;">
	<div class="header">
		<div class="logo">
			<img alt="" height="74" longdesc="银客对账系统"
				src="${yk}/gen-commons/images/common/logo_img3.png" width="156" />
		</div>
		<div class="userarea">
			<div>
				${sessionScope.SESSION_FULLNAME} <span id="hourZone"></span>欢迎你！
			</div>
			<div class="gggn">
	...
	<div id="mainbody">
		<div id="leftmenu">
			...
			<div id="switchBar">
				<img src="${yk}/gen-commons/images/common/layout-button-show.gif"
					alt="展开" height="17" width="19" />
			</div>
			<div class="panel-body">
				<iframe id="frame_menu" frameborder="0" scrolling="yes"
					src="${yk}/common/location.do?path=/login/left" target="_blank"></iframe>
			</div>
		</div>
		<div id="rightContainer">
			<div class="tab-wrap" style="height: 30px; overflow: hidden;">
				<ul class="tab-list clearfix" id="toptabs">
					<li class="tabs-selected"><span id=yeqian_content
						onclick='javascript:iframehide("content");'>欢迎页</span></li>
				</ul>
			</div>
			<div id="iframCreater">
				<iframe id="frame_content" frameborder="0" scrolling="auto"
					src="${yk}/common/location.do?path=/login/main" target="_blank"></iframe>
			</div>
		</div>
	</div>
	<div class="footer">
		<div class="version">银客对账系统V1.0版本</div>
		<div class="date">
			当前日期：<span id="currDateShow"></span>
		</div>
		<div class="brower">（推荐浏览配置：IE7.0+ 1280x800）</div>
	</div>
</body>
</html>
<script type="text/javascript">
