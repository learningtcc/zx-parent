...
<body>
	...
	<form id="form1" action="${yk}/PlatformData/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00"
			...
			<tr>
				...
				<td><input id="amt" name="amt"
					value="<c:out value="${model.amt}"/>" type="text" class="input04" />
			...
			<tr>
				...
				<td><input id="arrivedAmt" name="arrivedAmt"
					value="<c:out value="${model.arrivedAmt}"/>" type="text"
					class="input04" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">支付渠道（1：CMBC）:</td>
			...
			<tr>
				...
				<td><input onClick="WdatePicker()" id="payTimeString"
					value="<c:out value="${model.payTimeString}"/>"
					name="payTimeString" size="10" readonly="readonly" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">到账时间:</td>
				<td><input onClick="WdatePicker()" id="arrivedTimeString"
					value="<c:out value="${model.arrivedTimeString}"/>"
					name="arrivedTimeString" size="10" readonly="readonly" /></td>
			</tr>

			<tr>
				<td class="txtr" style="width: 188px">交易状态 1、待支付 2、支付成功 3、支付失败:
				</td>
				<td><input id="payStatus" name="payStatus"
					value="<c:out value="${model.payStatus}"/>" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input id="payMethod" name="payMethod"
					value="<c:out value="${model.payMethod}"/>" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input id="resideFlag" name="resideFlag"
					value="<c:out value="${model.resideFlag}"/>" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input onClick="WdatePicker()" id="resideToDateString"
					value="<c:out value="${model.resideToDateString}"/>"
