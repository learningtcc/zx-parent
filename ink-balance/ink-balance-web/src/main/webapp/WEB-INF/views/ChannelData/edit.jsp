...
<body>
	...
	<form id="form1" action="${yk}/ChannelData/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00"
			...
			<tr>
				...
				<td><input id="merchantNo" name="merchantNo"
					value="<c:out value="${model.merchantNo}"/>" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input id="receivedAmt" name="receivedAmt"
					value="<c:out value="${model.receivedAmt}"/>" type="text"
					class="input04" /></td>
			</tr>
			...
			<tr>
				...
				<td><input onClick="WdatePicker()" id="transTimeString"
					value="<c:out value="${model.transTimeString}"/>"
			...
			<tr>
				...
				<td><input id="transStatus" name="transStatus"
					value="<c:out value="${model.transStatus}"/>" type="text"
					class="input04" /></td>
			</tr>
