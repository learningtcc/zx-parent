...
<body>
	<div id="toolbar" class="">
		<table class="">
			<tr>
				<td><span>操作名称：</span> <input id="operationName"
	...
	<div id="dlg" style="width: 400px; height: 400px; padding: 10px"
		class="easyui-dialog" title="添加操作"
		...
		<form id="ff" method="post">
			<table cellpadding="0" cellspacing="0" style="width: 100%"
				...
				<tr>
					<td>操作名称:</td>
					<td><input id="" validtype="length[1,9]"
						class="easyui-textbox" type="text" name="operationName" required
						style="width: 160px;" /></td>
				</tr>
				<tr>
					<td>操作标识:</td>
					<td><input id="" validtype="length[1,9]"
						class="easyui-textbox" type="text" name="operationCode" required
						style="width: 160px;" /></td>
				</tr>
				<tr>
					<td>功能url:</td>
					<td><input id="" class="easyui-textbox" type="text"
						name="url" required style="width: 160px;" /></td>
				</tr>
				<tr>
					<td>操作描述:</td>
					<td><input id="" class="easyui-textbox" type="text"
						name="remark" required style="width: 160px;" /></td>
				</tr>
				<tr>
					<td>状态:</td>
					<td><input style="width: 160px;" class="easyui-combobox"
						required name="status" value="1"
						data-options="
										valueField: 'value',
										textField: 'text',
										data: [{
				...
				<!-- <tr>
					<td>备注:</td>
					<td><input id="" class="easyui-textbox" type="text"
						style="width: 160px;" name="remark" required /></td>
				<tr> -->
			</table>
		</form>
	...
	<div id="bb">
		...
		<script>
					...
					$.messager.confirm('删除', '确认删除吗', function(r) {
						if (r) {
							$.each(row,function(i,data){
								 $.ajax({
										url : 'operation/delete?id=' + data.id,
										success : function(b) {
											if (b) {
												$.messager.show({
													title : 'true',
			...
			function search() {
				...
				var params = {
					operationName : $('#operationName').textbox('getText'),
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function(value, rowData,
												rowIndex) {
											var url = 'operateDetail?operationId='
													+ rowData.id;
