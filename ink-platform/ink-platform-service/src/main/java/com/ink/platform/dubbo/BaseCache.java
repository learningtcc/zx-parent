...
public abstract class BaseCache {
	private static final YinkerLogger logger = YinkerLogger.getLogger(BaseCache.class);
	@Autowired
	private Yedis yedis;
	...
	protected void removeCache(String key, String field){
		synchronized (this) {
			try{
				...
				logger.error("删除缓存失败，key : "+key+"，field : {}"+field);
			}
		}
	}
