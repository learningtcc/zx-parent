...
<link href="${yk}/gen-commons/yinker-gen.css" rel="stylesheet" type="text/css" />
<link type="image/x-icon" href="${yk}/gen-commons/images/common/favicon.ico" rel="shortcut icon">
