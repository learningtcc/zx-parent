...
public class PayTest {
	...
	@Test
	public void test(){
		//CmbcPayInfo.merchantNoRechargeAndCash+asilePayAccountIn.getOrderNo();
		PayAccountIn payAccountIn=new PayAccountIn();
		payAccountIn.setAmount(new BigDecimal(1));
//		payAccountIn.setOrderNo(CmbcPayInfo.merchantNoRechargeAndCash+"1"+new Date().getTime());//"1"+new Date().getTime()//20160405614245dkkkjuuu
		//payAccountIn.setIdentityid("201604271949318660");//201604271946051306//201604271949318660//201604271949318660
...
//		payAccountIn.setSignId("20160316112504000000000000008786");
		...
		payAccountIn.setTradeDate(new Date());
