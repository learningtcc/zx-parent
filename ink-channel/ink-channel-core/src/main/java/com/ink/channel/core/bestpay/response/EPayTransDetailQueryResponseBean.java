 ...
 *
 */
public class EPayTransDetailQueryResponseBean extends EPayBaseResponseBean {
    ...
    private String stat;// 状态：000:成功 001:初始化 002:处理中 004:失败 010:冲正成功 021:退款成功 025:部分成功
