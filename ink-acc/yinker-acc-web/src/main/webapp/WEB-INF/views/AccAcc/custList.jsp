...
<form id="queryForm" name="queryForm" action="<c:url value="/AccAcc/custList.do"/>" method="post" style="display: inline;">
	...
	<h2>客户账户列表</h2>
		...
		<div>
     	 ...
     	 <yk:page url="${yk}/AccAcc/custList.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>
