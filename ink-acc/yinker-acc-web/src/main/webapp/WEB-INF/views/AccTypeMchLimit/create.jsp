...
<head>
	<title><%=AccTypeMchLimit.TABLE_ALIAS%>新增</title>
	<%@ include file="/gen-commons/taglibs.jsp" %>
</head>
<body>
<div class="title01">
	<h2>新增<%=AccTypeMchLimit.TABLE_ALIAS%></h2>
</div>
	<form id="form1" action="${yk}/AccTypeMchLimit/save.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<span id="sacTypeSpan" style="color: red"></span>
				</td>
			</tr>
			...
			<tr>	
				...
				<td>
				<input id="dayCashlmtAmt" name="dayCashlmtAmt" type="number" class="input04"  value="0" />
			...
			<tr>	
				...
				<td>
				<input id="dayCashlmtCnt" name="dayCashlmtCnt" type="number" class="input04"  value="0" />
