...
<form id="queryForm" name="queryForm" action="<c:url value="/AccInterestHistory/list.do"/>" method="post" style="display: inline;">
	...
	<h2>计息历史日志列表</h2>
		...
		<div>
     	 ...
     	 <yk:page url="${yk}/AccInterestHistory/list.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>
