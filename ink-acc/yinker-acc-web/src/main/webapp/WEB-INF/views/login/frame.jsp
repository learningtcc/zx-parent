...
<title>银客支付用户管理</title>
<script type="text/javascript">
function quit(){
	window.location = "${yk}/login/logout.do";
}
...
<div class="header">
	<div class="logo">
		<img alt="" height="74" longdesc="银客支付用户管理系统" src="${yk}/gen-commons/images/common/logo_img3.png" width="156" /></div>
	<div class="userarea">
		<div>
			<%=name%> <span id="hourZone"></span>欢迎你！</div>
		<div class="gggn">
...
<div id="mainbody">
	...
	<div id="rightContainer">
		...
		<div id="iframCreater">
			<!-- <iframe id="frame_content" frameborder="0" scrolling="auto" src="${yk}/SendInfo/list.do" target="_blank"></iframe>
			 -->
		</div>
	</div>
</div>
