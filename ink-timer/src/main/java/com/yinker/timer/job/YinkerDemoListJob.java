 ...
 */
@Service
public class YinkerDemoListJob {
    YinkerLoger logger=  YinkerLoger.getLogger(YinkerDemoListJob.class);
  ...
  //  private IUserMainManager userMainManager;
    ...
    public void  excute(){
        logger.info("YinkerDemoListJob  is loading...... " );
        try{
       //     List<UserMain> userList= userMainManager.find(null);

        }   catch (Exception e){
            logger.error("10001","YinkerDemoListJob error  " + e.getMessage());
        }
