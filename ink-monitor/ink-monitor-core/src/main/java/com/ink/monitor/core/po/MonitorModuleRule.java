...
public class MonitorModuleRule extends BaseEntity implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "MonitorModuleRule";
//	
...
//	
	...
	public boolean equals(Object obj) {
		if(obj instanceof MonitorModuleRule == false) return false;
		if(this == obj) return true;
		MonitorModuleRule other = (MonitorModuleRule)obj;
