...
<form name="userForm" action="<c:url value="/tfs/download.do"/>"  method="post" >
    文件名：<input type="text" id="fileName" name="fileName" value="">
    系统代码：<input type="text" id="sourceCode" name="sourceCode" value="">
    模块代码：<input type="text" id="moduleCode" name="moduleCode" value="">
