...
<div class="header">
	<div class="logo">
		<img alt=""  height="74" longdesc="银客任务调度系统" src="${yk}/gen-commons/images/common/logo_img3.png" width="156" /></div>
	<div class="userarea">
		<div>
			<span id="hourZone"></span>欢迎你！</div>
		<div class="gggn">
			<a class="quit" href="#" onclick="quit();"><span></span> 安全退出 </a></div>
	</div>
</div>
<div id="mainbody">
	<div id="leftmenu">
