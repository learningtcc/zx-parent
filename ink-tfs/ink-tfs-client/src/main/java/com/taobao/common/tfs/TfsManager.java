...
public interface TfsManager {
     ...
     * @return
     */
    boolean fetchFileForce(String tfsFileName, String tfsSuffix, String localFileName);
     ...
     * @return
     */
    boolean fetchFileForce(String tfsFileName, String tfsSuffix, OutputStream output);
     ...
     * @return
     */
    boolean fetchFileForce(String tfsFileName, String tfsSuffix, long offset, OutputStream output);
     ...
     * @return
     */
    boolean fetchFileForce(String tfsFileName, String tfsSuffix, long offset, long length, OutputStream output);
     ...
     * @return
     */
    long unlinkUniqueFile(String tfsFileName, String tfsSuffix);
