...
public class GoldGrantHistoryFilter extends MongoPageFilter {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7214779396534600811L;
	/** 创建时间 */
	...
	public String toString() {
		...
		builder.append("GoldGrantHistoryFilter [beginCreateTime=");
