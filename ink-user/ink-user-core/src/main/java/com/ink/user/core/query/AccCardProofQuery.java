...
public class AccCardProofQuery extends BaseQuery implements Serializable {
	...
	/** 修改前的手机号 */
	private java.lang.String beforeBankMblNo;
	/** 修改后的手机号 */
	...
	public java.lang.String getBeforeBankMblNo() {
		return this.beforeBankMblNo;
	}
	
	public void setBeforeBankMblNo(java.lang.String value) {
		this.beforeBankMblNo = value;
	}
