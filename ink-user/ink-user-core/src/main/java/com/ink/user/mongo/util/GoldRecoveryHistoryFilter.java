...
public class GoldRecoveryHistoryFilter extends MongoPageFilter {

	/**
	 * 
	 */
	private static final long serialVersionUID = 938642811108351888L;
	/** 创建时间 */
	...
	// 利息金额
	@MongoQueryKey(value = "recoveryAmt")
	...
	public String toString() {
		...
		builder.append("GoldRecoveryHistoryFilter [beginCreateTime=");
