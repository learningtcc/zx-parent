...
// * @author 作者 :bo.chen
// * @version 创建时间：2015年11月18日 下午1:25:15
// * @description 描述：
// * 
// */
...
//	
//	private static IdWorker idWorker=new IdWorker(ResourceBundleUtils.getValue(key, "conf/app"), 3l);
//	/**
//	 * id gernerte
//	 * @return
//	 */
...
//		System.out.println(ResourceBundleUtils.getValue(key, "conf/app"));
//		
