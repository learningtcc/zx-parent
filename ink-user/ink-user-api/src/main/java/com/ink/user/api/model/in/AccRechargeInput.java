 ...
 * @Description: 账户充值入参
 * @author wanghao^_^
 * @date 2016年6月12日 下午1:47:55
 */
public class AccRechargeInput implements Serializable {

	/**
	* @Fields serialVersionUID : TODO
	*/
	private static final long serialVersionUID = -5102523307212658244L;
	// 交易代码
	@NotNull
	@Length(max = 8)
...
//	@NotNull
	...
	public String toString() {
		...
		builder.append("AccRechargeInput [txnCode=");
