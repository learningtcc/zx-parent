 ...
 * 绑卡验证
 * @author yangchen
 * @date 2016年4月21日 下午5:03:16
 */
public class CheckBindCardInput implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8395537806867849112L;
	// 交易代码
	@NotNull
	@Length(max = 8)
	...
	public String toString() {
		...
		builder.append("CheckBindCardInput [txnCode=");
