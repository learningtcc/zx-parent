...
public class BasicBank extends BaseEntity implements java.io.Serializable {
    ...
    public BasicBank(java.lang.Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BasicBank == false)
            return false;
        if (this == obj)
            return true;
        BasicBank other = (BasicBank) obj;
