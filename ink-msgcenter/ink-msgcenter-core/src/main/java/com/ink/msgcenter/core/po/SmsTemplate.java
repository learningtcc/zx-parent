...
public class SmsTemplate extends BaseEntity implements java.io.Serializable {
...
//	
//	public static final String ALIAS_PARSE_METHOD = "解析方式1 JSON解析             2 顺序解析";
//	
...
//	
	...
	public String toString(String separator) {
		StringBuffer sb = new StringBuffer();
			...
			sb.append("解析方式1 JSON解析             2 顺序解析:").append(parseMethod).append(separator);
