 ...
 * @since 1.0
 */
public class YinkerListenerContainerParser implements BeanDefinitionParser {
	...
	private void parseListener(Element listenerEle, Element containerEle, ParserContext parserContext,
		...
		BeanDefinition containerDef = YinkerRabbitNamespaceUtils.parseContainer(containerEle, parserContext);
