...
import com.ink.base.log.rabbit.listener.YinkerSimpleMessageListeberContainer;

public class YinkerRabbitNamespaceUtils {
	...
	public static BeanDefinition parseContainer(Element containerEle, ParserContext parserContext) {
		RootBeanDefinition containerDef = new RootBeanDefinition(YinkerSimpleMessageListeberContainer.class);
