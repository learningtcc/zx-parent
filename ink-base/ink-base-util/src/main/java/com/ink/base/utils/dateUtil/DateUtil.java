package com.ink.base.utils.dateUtil;
...
public class DateUtil {
	 ...
	 * @throws ParseException 
	 */
	public static Date formatYYYYMMDDMMHHSSToStr(String str) throws ParseException {
		DateFormat format = DateFormat.getInstance("yyyyMMddHHmmss");
		return format.parse(str);
	}
	...
	public static String getDateMinute(Date logTime){
		DateFormat format = DateFormat.getInstance("yyyy-MM-dd HH:mm");
