...
@RequestMapping("/trade/AsileBankTemp")
@Controller
public class AsileBankTempController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/trade/AsileBankTemp/list";
	protected static final String CREATE_JSP = "/trade/AsileBankTemp/create";
	protected static final String EDIT_JSP = "/trade/AsileBankTemp/edit";
	protected static final String SHOW_JSP = "/trade/AsileBankTemp/show";
