...
@RequestMapping("/trade/BasicResCode")
@Controller
public class BasicResCodeController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/trade/BasicResCode/list";
	protected static final String CREATE_JSP = "/trade/BasicResCode/create";
	protected static final String EDIT_JSP = "/trade/BasicResCode/edit";
	protected static final String SHOW_JSP = "/trade/BasicResCode/show";
