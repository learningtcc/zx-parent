...
@RequestMapping("/trade/AsileResCode")
@Controller
public class AsileResCodeController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/trade/AsileResCode/list";
	protected static final String CREATE_JSP = "/trade/AsileResCode/create";
	protected static final String EDIT_JSP = "/trade/AsileResCode/edit";
	protected static final String SHOW_JSP = "/trade/AsileResCode/show";
