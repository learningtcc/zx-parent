...
@RequestMapping("/trade/AsileBusinessSupport")
@Controller
public class AsileBusinessSupportController extends BaseController {
	...
	//forward paths
	protected static final String LIST_JSP= "/trade/AsileBusinessSupport/list";
	protected static final String CREATE_JSP = "/trade/AsileBusinessSupport/create";
	protected static final String EDIT_JSP = "/trade/AsileBusinessSupport/edit";
	protected static final String SHOW_JSP = "/trade/AsileBusinessSupport/show";
