...
@Controller
@RequestMapping("/trade/TradeOrder")
public class TradeOrderController extends BaseController {
	//默认多列排序,example: username desc,createTime asc
		protected static final String DEFAULT_SORT_COLUMNS = null; 
		
		//forward paths
		protected static final String LIST_JSP= "/trade/TradeOrder/list";
		protected static final String SHOW_JSP= "/trade/TradeOrder/show";
