	...
	<div class="divbody">
		<div class="loginArea">
			<div class="loginPic00">
				<%--<img alt="" height="70" src="${yk}/gen-commons/images/common/xu-loginPic002.png" width="372"/>--%>
			</div>
			<div class="loginbox">
				<div class="bd">
					<h2>银客后台管理系统</h2>
					...
					<div class="field">
						...
						<input id="username" class="login-text" maxlength="32"
							   name="username" tabindex="1" type="text"/>
					</div>
					<div class="field">
						<label for="" class="login-text2"></label>
						<input id="password" class="login-text" maxlength="32"
							   name="password" tabindex="1" type="password"
							   autocomplete="off"/>
					</div>

					<div class="submit">
						<input class="S-Submit" name="Submit1" type="button" value="" onclick="formValidate()"/>
					</div>
				</div>
			</div>
			<!--
