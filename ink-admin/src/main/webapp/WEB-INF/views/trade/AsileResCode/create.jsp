...
<div class="title01">
	...
	<form id="form1" action="${yk}/trade/AsileResCode/save.do" method="post">
...
<!-- 			</tr> -->
			...
			<tr>	
				...
				<td>
				<input id="asileResCode" name="asileResCode" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="asileResMsg" name="asileResMsg" type="text" class="input04"   />
