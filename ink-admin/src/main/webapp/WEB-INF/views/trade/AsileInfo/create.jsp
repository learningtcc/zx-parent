...
<div class="title01">
	...
	<form id="form1" action="${yk}/trade/AsileInfo/save.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="asileFeeName" name="asileFeeName" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="asileFeeNo" name="asileFeeNo" type="text" class="input04"   />
...
<!-- 				</td>	 -->
<!-- 				<td> -->
<!-- 				<input id="asileStatus" name="asileStatus" type="text" class="input04"   /> -->
...
<!-- 			</tr> -->
			...
			<!-- <tr>	
				...
				<td>
				<input id="transType" name="transType" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="asileAuditStatus" name="asileAuditStatus" type="text" class="input04"   />
