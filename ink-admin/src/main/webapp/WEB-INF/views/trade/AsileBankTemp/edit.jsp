...
<div class="title01">
	...
	<form id="form1" action="${yk}/trade/AsileBankTemp/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<yk:constantConvert htmlTag="select" dataTag="asileName" paramValue="${model.asileCode}" codeTag="asileCode" nameTag="asileName" data="${asileInfos}" name="asileCode" isAutoItem="false" emptyTip="0"/>
...
<!-- 			</tr> -->
			...
			<tr>	
				...
				<td>
				<yk:constantConvert htmlTag="select" paramValue="${model.bankCode}" dataTag="bankName" codeTag="bankShortName" nameTag="bankName" data="${basicBanks}" name="bankCode" isAutoItem="false" emptyTip="0"/>
				</td>
			</tr>
...
<!-- 			</tr> -->
			...
			<tr>	
				...
				<td>
				<yk:constantConvert htmlTag="select" dataTag="asilePayType" codeTag="code" paramValue="${model.asilePayType}" nameTag="value" data="${routeBusinessType}" name="asilePayType" isAutoItem="false" emptyTip="0"/>
				</td>
			</tr>
			...
			<tr>	
				...
				<td>
				<input id="asileAmtStart" name="asileAmtStart" value="<c:out value="${model.asileAmtStart}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="asileAmtEnd" name="asileAmtEnd" value="<c:out value="${model.asileAmtEnd}"/>" type="text" class="input04"   />
