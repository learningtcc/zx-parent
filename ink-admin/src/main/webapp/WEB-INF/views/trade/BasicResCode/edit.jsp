...
<div class="title01">
	...
	<form id="form1" action="${yk}/trade/BasicResCode/update.do" method="post">
...
<!-- 				</td>	 -->
<!-- 				<td> -->
<%-- 				<input id="isCustReason" name="isCustReason" value="<c:out value="${model.isCustReason}"/>" type="text" class="input04"   /> --%>
...
<!-- 				</td>	 -->
<!-- 				<td> -->
<%-- 				<input id="isAgain" name="isAgain" value="<c:out value="${model.isAgain}"/>" type="text" class="input04"   /> --%>
