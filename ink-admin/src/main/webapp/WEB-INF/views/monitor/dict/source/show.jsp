...
<body>
	...
	<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
		<tr>	
			<td class="txtr" style="width: 188px">平台系统名:</td>
			<td><c:out value="${model.name}"/></td>
		</tr>
		<tr>	
			<td class="txtr" style="width: 188px">平台系统码:</td>
			<td><c:out value="${model.code}"/></td>
		</tr>
		<tr>	
			<td class="txtr" style="width: 188px">节点数:</td>	
			<td><c:out value="${model.count}"/></td>
		</tr>
		<tr>	
			<td class="txtr" style="width: 188px">Ip列表:</td>	
			<td><c:out value="${model.ipList}"/></td>
		</tr>
		<tr>	
