...
<form id="form1" action="${yk}/monitor/service/dict/update.do" method="post">

  <table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
    <input type="hidden" id="id" name="id" value="<c:out value="${model.id}"/>"/>
    <input id="sysCode" name="sysCode" value="<c:out value="${model.sysCode}"/>" type="hidden"/>
    ...
    <tr>
      <td class="txtr" style="width: 188px">
        服务类型<label style="color: red">*</label>:
      </td>
      <td>
        <%--<input id="sourceType" name="sourceType" value="<c:out value="${model.sourceType}"/>" type="text" class="input04"   />--%>
    ...
    <tr>
      ...
      <td>
        <input id="sourceName" name="sourceName" value="<c:out value="${model.sourceName}"/>" type="text" class="input04"  required="true" />
      </td>
    </tr>
    <tr>
      <td class="txtr" style="width: 188px">
      ...
      <td>
        <input id="sourceUrl" name="sourceUrl" value="<c:out value="${model.sourceUrl}"/>" type="text" class="input04"  required="true" />
      </td>
    </tr>
...
<script type="text/javascript">
  $(function(){
    ...
    $("#subSave").click(function(){
      ...
      if(validateLengthFrom("sourceName",1,"资源名称不能为空")
