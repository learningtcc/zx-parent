...
<div class="title01">
	...
	<form id="form1" action="${yk}/userext/BatchLog/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="batchId" name="batchId" value="<c:out value="${model.batchId}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="itemCount" name="itemCount" value="<c:out value="${model.itemCount}"/>" type="text" class="input04"   />
