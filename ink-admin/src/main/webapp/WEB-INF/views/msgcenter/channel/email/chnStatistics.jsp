...
<body>
	<table width="98%" class="table00" style="border: 1px solid;">
		<tr>
			<th colspan="3"><span style="font-size: 20px;">${emailChannel.name }(${emailChannel.chnCode};${emailChannel.mailAddr})</span></th>
		</tr>
	...
	<table width="98%" style="border: 1px solid;padding-top: 10px;" cellspacing="0" cellpadding="0" class="table00">
		...
		<td align="center">
			<div id="myStat3" data-dimension="100" data-text="${success }%" data-info="成功" data-width="7" data-fontsize="15" data-percent="${success }" data-fgcolor="#00DB00" data-bgcolor="#eee"></div>
		</td>
		<td align="center">
			<div id="myStat4" data-dimension="100" data-text="${fail }%" data-info="失败" data-width="7" data-fontsize="15" data-percent="${fail }" data-fgcolor="#FF0000" data-bgcolor="#eee"></div>
		</td>
		</tr>
	</table>
