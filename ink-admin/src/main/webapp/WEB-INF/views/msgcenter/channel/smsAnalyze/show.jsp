...
<head>
	<title><%=SmsAnalyze.TABLE_ALIAS%>信息</title>
	<%@ include file="/gen-commons/taglibs.jsp" %>
</head>
<body>
	<div class="title01">
	<h2><%=SmsAnalyze.TABLE_ALIAS%>详情</h2>
</div>
	<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
		...
		<tr>	
			<td class="txtr" style="width: 188px">送达总数:</td>	
			<td><c:out value="${model.deliveCount}"/></td>
		</tr>
		<tr>	
			<td class="txtr" style="width: 188px">上行总数:</td>	
			<td><c:out value="${model.upCount}"/></td>
		</tr>
		<tr>	
