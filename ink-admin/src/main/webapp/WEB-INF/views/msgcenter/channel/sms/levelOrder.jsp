...
<head>
  ...
  <SCRIPT type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $.post("${yk}/msgcenter/channel/sms/findMonitorServiceTree.do",function(data){
        if(data != null){
...
<form action="${yk}/msgcenter/channel/sms/saveLevelOrder.do" id="form1" name="form1" method="post">
