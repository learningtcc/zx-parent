...
<head>
	<title><%=SmsCode.TABLE_ALIAS%>编辑</title>
	<%@ include file="/gen-commons/taglibs.jsp" %>
</head>
<body>
<div class="title01">
	<h2>修改<%=SmsCode.TABLE_ALIAS%></h2>
</div>
	<form id="form1" action="${yk}/msgcenter/SmsCode/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="extInfo" name="extInfo" value="<c:out value="${model.extInfo}"/>" type="text" class="input04"   />
