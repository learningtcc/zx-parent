...
<head>
	<title><%=SmsTemplateLog.TABLE_ALIAS%> 维护</title>
...
<form id="queryForm" name="queryForm" action="<c:url value="/msgcenter/SmsTemplateLog/list.do"/>" method="post" style="display: inline;">
