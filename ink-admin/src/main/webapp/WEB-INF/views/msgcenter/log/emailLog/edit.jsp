...
<head>
	<title><%=EmailLog.TABLE_ALIAS%>编辑</title>
	<%@ include file="/gen-commons/taglibs.jsp" %>
</head>
<body>
<div class="title01">
	<h2>修改<%=EmailLog.TABLE_ALIAS%></h2>
</div>
	<form id="form1" action="${yk}/msgcenter/EmailLog/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="subject" name="subject" value="<c:out value="${model.subject}"/>" type="text" class="input04"   />
			...
			<tr>	
				...
				<td>
				<input id="mailMsg" name="mailMsg" value="<c:out value="${model.mailMsg}"/>" type="text" class="input04"   />
