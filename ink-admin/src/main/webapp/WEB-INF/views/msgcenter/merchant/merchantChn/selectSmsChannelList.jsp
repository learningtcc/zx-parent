...
<form id="selectForm" action="${yk}/msgcenter/merchant/merchantChn/saveSmsChannelList.do">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tb" class="table02">
            ...
            <c:forEach items="${dataList}" var="item">
                <tr>
                    ...
                    <td>
                        <div>
                            <yk:constantConvert htmlTag="text" name="chnType" dataTag="chnType" paramValue="${item.chn_type}" sysTag="msgcenter"/>
                        </div>
                    </td>
                </tr>
            </c:forEach>
