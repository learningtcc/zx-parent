...
<head>
	<title><%=MerchantChn.TABLE_ALIAS%>新增</title>
	<%@ include file="/gen-commons/taglibs.jsp" %>
</head>
<body>
<div class="title01">
	<h2>新增<%=MerchantChn.TABLE_ALIAS%></h2>
</div>
	<form id="form1" action="${yk}/msgcenter/MerchantChn/save.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="chnType" name="chnType" type="text" class="input04"   />
