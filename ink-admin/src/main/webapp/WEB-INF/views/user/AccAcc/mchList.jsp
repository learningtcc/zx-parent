...
<form id="queryForm" name="queryForm" action="<c:url value="/user/AccAcc/mchList.do"/>" method="post" style="display: inline;">
	...
	<h2>商户账户列表</h2>
		...
		<div>
     	 ...
     	 <yk:page url="${yk}/user/AccAcc/list.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>
