	...
	<form id="form1" action="${yk}/AccTypeMchLimit/update.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<yk:select codeName="sac_name" table="acc_sac_type" codeValue="sac_type" id="sacType" name="sacType" select="${model.sacType }" where=" status = 1" serviceName="userDubboBaseService"></yk:select>
			...
			<tr>	
				...
				<td>
				<yk:select codeName="mch_name" table="acc_mch" codeValue="mch_id" id="mchId" name="mchId" select="${model.mchId }" where=" del_flag != 1" serviceName="userDubboBaseService"></yk:select>
				<span class="required">*</span>
				</td>
			</tr>
