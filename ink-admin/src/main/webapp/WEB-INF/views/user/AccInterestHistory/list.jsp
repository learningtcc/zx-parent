...
<form id="queryForm" name="queryForm" action="<c:url value="/user/AccInterestHistory/list.do"/>" method="post" style="display: inline;">
		...
		<div>
			...
			<thead>
			 <tr>
				...
				<th>主账号ID<div style="width: 65px; height: 1px; overflow: hidden;"></div></th>
				<th>子账户种类<div style="width: 65px; height: 1px; overflow: hidden;"></div></th>
				<th>当前余额<div style="width: 65px; height: 1px; overflow: hidden;"></div></th>
				<th>利息金额<div style="width: 65px; height: 1px; overflow: hidden;"></div></th>
			...
			<tr>
				...
				<td>
				<div><c:out value="${entry.interestAmt}"/></div>
				</td>
				<td>
     	 ...
     	 <yk:page url="${yk}/user/AccInterestHistory/list.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>
