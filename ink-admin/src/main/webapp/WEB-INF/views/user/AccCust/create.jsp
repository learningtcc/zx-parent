...
<div class="title01">
	...
	<form id="form1" action="${yk}/user/AccCust/save.do" method="post">
		...
		<table cellpadding="0" cellspacing="0" class="table00" style="width: 100%">
			...
			<tr>	
				...
				<td>
				<input id="custId" name="custId" type="text" class="input04"   />
...
function validateForm(){
	...
	$("#custId").change(function(){
		...
		if($("#mchId").val().length > 1){
			$.post("${yk}/user/AccCust/checkExist.do",{mchId : $("#mchId").val(), custId : $("#custId").val()},function(data){
				console.info(data);
				if(data == "1"){
					alert("该商户的此客户号已存在");
