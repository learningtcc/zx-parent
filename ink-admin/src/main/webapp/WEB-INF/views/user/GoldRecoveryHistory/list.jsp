...
<form id="queryForm" name="queryForm" action="<c:url value="/user/GoldRecoveryHistory/list.do"/>" method="post" style="display: inline;">
	...
	<h2>体验金回收日志列表</h2>
		...
		<div>
     	 ...
     	 <yk:page url="${yk}/GoldRecoveryHistory/list.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>
