...
<form id="queryForm" name="queryForm" action="<c:url value="${yk}/user/AccAccLog/list.do"/>" method="post" style="display: inline;">
	...
	<h2>账户信息日志列表</h2>
		...
		<div>
     	 ...
     	 <yk:page url="${yk}/user/AccAccLog/list.do" id="logForm" submitForm="queryForm" joy="true"/>
</div>

<script type="text/javascript">
function show(id){
	window.open('${yk}/user/AccAccLog/show.do?'+$('#pkName').val()+'='+id,'','height=600,width=600,resizable=yes,location=no,scrollbars');
}
function edit(id){
